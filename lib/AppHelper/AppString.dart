...
class EnglishString extends Strings {
  EnglishString() {
    ...
    alertWrongChange =
        'It is not modified password. Please be sure to write a new password';
    ...
    sendPassword =
        'We have sent a message containing the password to your email';
    sendProduct = 'Your order has been sent successfully';
    sendProductinfo =
        'We will contact with you to determine the date of receipt of the order';
...
class ArabicString extends Strings {
  ArabicString() {
    ...
    sendPassword =
        'لقد تم ارسال كلمة السر الى البريد الالكتروني الرجاء التاكد ';
    serviceNoti = 'الخدمة:';
    ...
    alerterror = 'تنبيه';
    alertWrongChange =
        'لم يتم تعديل كلمة المرور. الرجاء التأكد من كتابة كلمة مرور جديدة';
